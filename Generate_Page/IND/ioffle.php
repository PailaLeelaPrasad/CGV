...
<body>
    <form action="" method="post">
        ...
        <label for="full-name">Inter Name:</label>
        ...
        <label for="father-name">Domain:</label>
...
$conn = new PDO($db_name, $username, $password);
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO ioffle (full_name, gender, dob, place_of_birth, father_name, registration_number)
            VALUES ('$full_name', '$gender', '$dob', '$place_of_birth', '$father_name', '$registration_number')";
