...
<body>
    <form action="" method="post">
        ...
        <label for="father-name">Academic Session:</label>
        <input type="text" id="father-name" name="income" required>
        
        <label for="father-name">GPA:</label>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO tc (full_name, father_name, income, incomet, address, pincode, registration_number)
            VALUES ('$full_name', '$father_name', '$income', '$incomet', '$address', '$pincode', '$registration_number')";
