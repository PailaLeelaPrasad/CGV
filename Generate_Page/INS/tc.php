...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO tc (full_name, father_name, income, address, pincode, registration_number)
            VALUES ('$full_name', '$father_name', '$income', '$address', '$pincode', '$registration_number')";
