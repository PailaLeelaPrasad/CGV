...
<body>
    <form action="" method="post">
        <h2>Intermediate Certificate</h2>

        <label for="full-name">Full Name:</label>
        <input type="text" id="full-name" name="full_name" required>

        <label for="father-name">College Name</label>
        <input type="text" id="father-name" name="college" required>

        <label for="full-name">Father Name:</label>
        <input type="text" id="full-name" name="father_name" required>

        <label for="mother-name">Completed Date:</label>
        <input type="date" id="mother-name" name="cdate" required>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO inter (full_name, college, father_name, cdate, address, pincode, registration_number)
            VALUES ('$full_name', '$college', '$father_name', '$cdate', '$address', '$pincode', '$registration_number')";
